...
小水内容创作诊断。帮你识别真需求、挖掘潜意识阻碍，用完整方法论陪你一步步完成内容创作。
...
- **dbs-diagnosis**: 商业模式诊断 → 战略层面
- **xiaoshui-content**: 内容创作诊断 + 陪伴式创作 → 执行层面

可以先用 dbs-diagnosis 诊断商业模式，再用 xiaoshui-content 落地到具体内容创作。
